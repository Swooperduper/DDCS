...
var neutralCCController = require('../action/neutralCC');
var DCSLuaCommands = require('../player/DCSLuaCommands');
var zoneController = require('../proxZone/zone');
var groupController = require('../spawn/group');
var taskController = require('../action/task');
var openSAM = 0;
...
_.set(exports, 'convoyRouteTemplate', function (routes) {
    ...
    var cNum = 1;
    _.forEach(_.get(routes, 'routeLocs'), function (route) {
...
_.set(exports, 'spawnSupportBaseGrp', function (serverName, baseName, side) {
    ...
    var farpBases = _.filter(curBases, function (baseObj) {
...
_.set(exports, 'spawnConvoy', function (serverName, groupName, convoySide, baseTemplate, AIConfig, mesg) {
    ...
    var unitNum = 1;
    _.forEach(curConvoyMakeup, function (convUnit) {
    ...
    masterDBController.cmdQueActions('save', serverName, actionObj)
        ...
        taskController.setMissionTask(serverName, groupName, JSON.stringify(exports.convoyRouteTemplate(curGrpObj)))
            .then(function () {
            DCSLuaCommands.sendMesgToCoalition(convoySide, serverName, mesg, 20);
        })["catch"](function (err) {
...
_.set(exports, 'spawnDefenseChopper', function (serverName, playerUnitObj, unitObj) {
    ...
    masterDBController.baseActions('getClosestFriendlyBase', serverName, { unitLonLatLoc: playerUnitObj.lonLatLoc, playerSide: playerUnitObj.coalition })
        ...
        masterDBController.cmdQueActions('save', serverName, actionObj)
            ...
            DCSLuaCommands.sendMesgToCoalition(playerUnitObj.coalition, serverName, mesg, 20);
        })["catch"](function (err) {
...
_.set(exports, 'spawnSupportPlane', function (serverName, baseObj, side) {
    ...
    masterDBController.cmdQueActions('save', serverName, actionObj)
        ...
        DCSLuaCommands.sendMesgToCoalition(side, serverName, mesg, 20);
    })["catch"](function (err) {
        console.log('erroring line428: ', err);
    });
});
...
_.set(exports, 'spawnLogisticCmdCenter', function (serverName, staticObj, init, baseObj, side) {
    ...
    masterDBController.unitActions('updateByName', serverName, { name: curGrpObj.name, coalition: curGrpObj.coalition, country: curGrpObj.country, dead: false })["catch"](function (err) {
        console.log('erroring line2181: ', err);
    });
});
